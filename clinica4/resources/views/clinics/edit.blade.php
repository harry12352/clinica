...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form"  action="{{ url ('clinics',$clinic->id)}}" method="POST"                                enctype="multipart/form-data">
				@csrf
				...
				<div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="text" name="name" value="{{$clinic->clinic_name}}">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Email</span>
					<input class="input100" type="text" name="email" value="{{$clinic->email}}">
					<span class="focus-input100"></span>
				</div>
								<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Password</span>
					<input class="input100" type="password" name="password" value="{{$clinic->password}}">
					<span class="focus-input100"></span>
				</div>
...
<!-- 						<div class="wrap-input100 validate-input" data-validate="Name is required">
 ...
 -->
					...
					<input class="input100" type="text" name="address" value="{{$clinic->address}}">
					<span class="focus-input100"></span>
				</div>
...
<!-- 
 ...
 -->
					...
					<input class="input100" type="number" name="phone" value="{{$clinic->contact_no}}">
					<span class="focus-input100"></span>
				</div>
