...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form"  action="{{ url ('patients',$patient->id)}}" method="POST"                                enctype="multipart/form-data">
				@csrf
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="text" name="email" value="{{$patient->email}}">
					<span class="focus-input100"></span>
				</div>
								<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Password</span>
					<input class="input100" type="password" name="password" value="{{$patient->password}}">
					<span class="focus-input100"></span>
				</div>
...
<!-- 				<div class="wrap-input100 validate-input" data-validate="Name is required">
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="number" name="cnic" value="{{$patient->cnic}}">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="number" name="phone" value="{{$patient->phone_no}}">
					<span class="focus-input100"></span>
				</div>
