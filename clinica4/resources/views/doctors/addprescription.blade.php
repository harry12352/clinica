...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form"  action="{{ route ('submitpres',[$appid,$patid])}}" method="POST" >	
...
<!-- 				<div class="wrap-input100 validate-input" data-validate="Name is required">
 ...
 -->
					...
					<input class="input100" type="text" name="name"  value="{{$patient->patient_name}}">
					<span class="focus-input100"></span>
				</div>
					...
					<input class="input100" type="text" name="address" value="{{$patient->address}}">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="number" name="age" value="{{$patient->age}}">
					<span class="focus-input100"></span>
				</div>
...
<!-- 				<div class="wrap-input100 input100-select">
				  ...
				  <div class="wrap-input100 validate-input" data-validate="Name is required">
					...
					<input class="input100" type="text" name="diagnosis" placeholder="Dignosis go here">
					<span class="focus-input100"></span>
				</div>
				  ...
				  <div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Medicines</span>
					<input class="input100" type="text" name="medicine" placeholder="Enter medicines here">
					<span class="focus-input100"></span>
				</div>
				  ...
				  <div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">lab Tests</span>
					<input class="input100" type="text" name="lab" placeholder="lab test if any">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					...
					<textarea class="input100" name="notes" placeholder="Notes go here"></textarea>
					<span class="focus-input100"></span>
				</div>
