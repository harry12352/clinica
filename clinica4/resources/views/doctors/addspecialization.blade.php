...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form"  action="{{ url ('insertspecialization')}}" method="POST"         >
				@csrf
...
<!-- 				<div class="wrap-input100 validate-input" data-validate="Name is required">
 ...
 -->
						<!-- <div class="wrap-input100 validate-input" data-validate="Name is required">
					<span class="label-input100">Add Specialization</span>
					<input class="input100" type="text" name="specialization" placeholder="Your Specialization">
					<span class="focus-input100"></span>
				</div>
 -->
				<!-- <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
...
<!-- 
 ...
 -->				<!-- 	<span class="focus-input100"></span>
							...
							<div class="wrap-input100 input100-select">
					<span class="label-input100">Select Specialization</span>
					<div>
						<select class="selection-2" name="specialization">
							@foreach($sp as $sp2)

							<option value="{{$sp2->id}}" name="specialization">{{$sp2->name}}</option>
