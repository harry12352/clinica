...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form"  action="{{ url ('doneregisteration',$clinicId)}}" method="POST"                            >
				@csrf
...
<!-- 
 ...
 -->
					...
					<div>
						<select class="selection-2" name="degree">
							<option>Mbbs</option>
							<option>Bds</option>
 ...
 -->						</select>
					...
					<span class="focus-input100"></span>
							...
							<div class="wrap-input100 input100-select">
					<span class="label-input100">Working Experience</span>
					<div>
						<select class="selection-2" name="experience">
 ...
 -->						</select>
					...
					<div class="wrap-input100 input100-select">
					<span class="label-input100">Contract Time</span>
					<div>
						<select class="selection-2" name="contract">
							<option>2 year</option>
...
<!-- 
				<div class="wrap-input100 input100-select">
					...
					<div>
						<select class="selection-2" name="fee">
							<option>1000 rupee</option>
							<option>2000 rupee </option>
							<option>3000 rupee </option>
 -->
							<!-- <option>eCommerce Bussiness</option>
							<option>UI/UX Design</option>
							<option>Online Services</option>
 ...
 -->
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Fee</span>
					<input class="input100" type="number" name="fee" placeholder="Whats your fee could be?">
					<span class="focus-input100"></span>
				</div>


								<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					<span class="label-input100">Identification Code</span>
