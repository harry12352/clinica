...
<h2><b>My Education</b> (<ins><a href="addeducation">Add Education</a></ins>)</h2>
          ...
          <td>{{$appointment->address}}</td>
            <td>{{$appointment->country}}</td>
              <td>{{$appointment->region}}</td>
                ...
                <td>
             <a href="{{ route ('addpres',[$appointment->id,$appointment->patient_id,$appointment->doctor_id,$appointment->clinic_name]) }}">Add</a>
